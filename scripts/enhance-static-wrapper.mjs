...
body{box-sizing:border-box;height:100vh;padding:1rem;display:grid;grid-template-rows:auto minmax(0,1fr);gap:.75rem;background:inherit}
...
if (!html.includes('id="course-frame"') || !html.includes('id="copy-progress"')) {
